...
WebUI.setText(findTestObject('Object Repository/Registro_mitele/input_Regstrate en Mediaset_username'), 'canosa1')

WebUI.setText(findTestObject('Object Repository/Registro_mitele/input_Regstrate en Mediaset_email'), 'canosa1.msn.com')
...
WebUI.verifyElementPresent(findTestObject('Registro_mitele/span_La direccin de correo electrnico no es vlida'), 3)
