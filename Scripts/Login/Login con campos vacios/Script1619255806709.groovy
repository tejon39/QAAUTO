...
WebUI.click(findTestObject('Iniciar sesion/Entrar'), FailureHandling.OPTIONAL)

WebUI.verifyElementPresent(findTestObject('Object Repository/Iniciar sesion/span_Este campo es obligatorio'), 3)
